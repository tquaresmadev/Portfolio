          ...
          <div className="flex flex-col gap-6 lg:col-span-2">
            ...
            <div className="rounded-2xl border border-border/60 bg-bg-card/50 p-6 backdrop-blur-sm">
              ...
              <div className="flex gap-3">
                <a href="https://github.com/j1mp-dev" target="_blank" rel="noopener noreferrer" className="flex h-10 w-10 items-center justify-center rounded-lg border border-border/60 text-fg-muted transition-all hover:border-accent/40 hover:text-fg">
